...
const ReservationSchema = new Schema<IReservation>({
  ...
  status: { type: String, enum: ["confirmed", "pending", "cancelled", "checked_in", "checked_out", "inquiry"], default: "confirmed" },
  source: { type: String },
  notes: { type: String },
}, { timestamps: true });
...
export const Reservation: Model<IReservation> = mongoose.models.reservations || mongoose.model<IReservation>("reservations", ReservationSchema);
