...
function SettingsFallback() {
  return (
    <div className="flex flex-col gap-8 p-10 max-w-6xl mx-auto w-full">
      <div className="space-y-2">
...
const VARIANTS = {
  cards:    { Fallback: CardsFallback },
  table:    { Fallback: TableFallback },
  chat:     { Fallback: ChatFallback },
  calendar: { Fallback: CalendarFallback },
  settings: { Fallback: SettingsFallback },
} as const;
